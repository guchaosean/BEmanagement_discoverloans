                                            ...
                                            <table align="center">
                                               ...
                                               <td style="color:#666;padding:15px; padding-bottom:0;font-size:14px;line-height:20px;font-family:arial;text-align:left">
                                                    ...
                                                    <div style="font-style:normal;padding-bottom:15px;font-family:arial;line-height:20px;text-align:left">
                                                        ...
                                                        <p><span style="font-weight:bold;font-size:16px">Sender telephone:</span> '.$sendertelephone.'</p>
														...
														<p><span style="font-weight:bold;font-size:16px">Attachment 1:</span> '.$order_upload1.' </p>
														<p><span style="font-weight:bold;font-size:16px">Attachment 2:</span> '.$order_upload2.' </p>
														<p><span style="font-weight:bold;font-size:16px">Attachment 3:</span> '.$order_upload3.' </p>
